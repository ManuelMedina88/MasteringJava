...
public class Quiz extends JFrame
{
   ...
   private QuizQuestionAnswers QA;
      ...
      public void actionPerformed(ActionEvent event)
      {
         if(counter < QA.getLength()) {
            if (textField.getText().equals(QA.getAnswer(counter))) {
               JOptionPane.showMessageDialog(Quiz.this, "It's correct!");
               counter++;
               textField.setText("");
               goods++;
               if(counter < QA.getLength())
               ...
               JOptionPane.showMessageDialog(Quiz.this, "you fail.\n"+ QA.getAnswer(counter));
               textField.setText("");
               bads++;
               counter++;
               if(counter < QA.getLength()) {
               ...
               if(counter >= QA.getLength()) {
                  ...
                  JOptionPane.showMessageDialog(Quiz.this, string);
                  counter = 0;
                  textField.setText("");
                  label1.setText(QA.getQuestion(counter));
                  bads = 0;
   ...
   private class ButtonHandler1 implements ActionListener
   {
      ...
      public void actionPerformed(ActionEvent event)
      {
         if(counter < QA.getLength()) {
            ...
            JOptionPane.showMessageDialog(Quiz.this, answer);
            counter++;
            textField.setText("");
            label1.setText(QA.getQuestion(counter));
            bads--;
