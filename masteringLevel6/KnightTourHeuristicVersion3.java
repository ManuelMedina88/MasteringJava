...
public class KnightTourHeuristicVersion3
{
   ...
   public static int movementAhead(int... steps)
   {
      boolean truth = true;

      boolean[] possibleSteps2 = new boolean[8];
      for(int i = 0; i < possibleSteps2.length; i++)
      {
         possibleSteps2[i] = false;
      }
