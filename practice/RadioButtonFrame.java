...
public class RadioButtonFrame extends JFrame
{
   ...
   private final JRadioButton italicJRadioButtton; // selects italic text
   ...
   public RadioButtonFrame()
   {
      ...
      radioGroup.add(italicJRadioButtton); // add italic to group
      ...
      italicJRadioButtton.addItemListener(
